...
### Operators
Original link: https://docs.oracle.com/javase/tutorial/java/nutsandbolts/QandE/questions_operators.html
1. ```int i = 10; int n = i++%5;``` After execution, i = 11, n = 0.
2. ```int i = 10; int n = ++i%5;``` After execution, i = 11, n = 1.
3. To invert the value of a boolean, which operator would you use? Use **"!"** - logical complement operator.
